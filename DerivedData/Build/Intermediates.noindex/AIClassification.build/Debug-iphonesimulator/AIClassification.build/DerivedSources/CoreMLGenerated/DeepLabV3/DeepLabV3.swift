...
class DeepLabV3Output : MLFeatureProvider {
    ...
    var semanticPredictions: MLMultiArray {
        provider.featureValue(for: "semanticPredictions")!.multiArrayValue!
    }

    /// Array of integers of the same size as the input image, where each value represents the class of the corresponding pixel. as 513 by 513 matrix of 32-bit integers
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    var semanticPredictionsShapedArray: MLShapedArray<Int32> {
        MLShapedArray<Int32>(semanticPredictions)
    }
...
class DeepLabV3 {
    ...
    */
    ...
    func prediction(input: DeepLabV3Input, options: MLPredictionOptions = MLPredictionOptions()) async throws -> DeepLabV3Output {
